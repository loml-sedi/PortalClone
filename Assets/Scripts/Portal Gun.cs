...
public class PortalGun : MonoBehaviour
{
   ...
   public Transform firePoint;
    ...
    private void ShootPortal(GameObject portal)
    {
        ...
        Vector2 direction = mousePosition - (Vector2)firePoint.position; //Get direction of mouse

        direction.Normalize();

        RaycastHit2D hit = Physics2D.Raycast(firePoint.position, direction, 100f, portalLayer); //Detect the portal layer
